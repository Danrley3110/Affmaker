...
export default function App() {
  ...
  const handleOfferClick = (product: Product) => {
    ...
    saveToLocal('affili_products', updatedProducts);
                  ...
                  <div className="flex items-center justify-between mb-6">
                    ...
                    <button 
                      onClick={() => {
                        ...
                        setProducts(updated);
                        saveToLocal('affili_products', updated);
                      }}
                    ...
                    {products.map(p => (
                      <div key={p.id} className="p-4 bg-gray-50 rounded-2xl grid grid-cols-1 md:grid-cols-4 gap-4 items-center">
                        <div className="flex items-center gap-3 col-span-1 md:col-span-2">
                          ...
                          <div className="flex-grow">
                            ...
                            <input 
                              ...
                              onChange={(e) => {
                                const updated = products.map(item => item.id === p.id ? { ...item, affiliateLink: e.target.value } : item);
                                setProducts(updated);
                                saveToLocal('affili_products', updated);
                              }}
                            />
                        ...
                        <div className="grid grid-cols-2 gap-2">
                          <div className="flex flex-col">
                            ...
                            <input 
                              ...
                              onChange={(e) => {
                                ...
                                const updated = products.map(item => item.id === p.id ? { ...item, promoPrice: val } : item);
                                setProducts(updated);
                                saveToLocal('affili_products', updated);
                              }}
                            />
                          ...
                          <div className="flex flex-col">
                            <span className="text-[10px] uppercase font-bold text-gray-400">Desc %</span>
                            <input 
                              type="number"
                              className="bg-transparent font-bold text-sm outline-none"
                              value={p.discount}
                              onChange={(e) => {
                                ...
                                const updated = products.map(item => item.id === p.id ? { ...item, discount: val } : item);
                                setProducts(updated);
                                saveToLocal('affili_products', updated);
                              }}
                            />
                    ...
                    {banners.map(b => (
                      <div key={b.id} className="p-6 bg-gray-50 rounded-3xl space-y-4">
                        ...
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = banners.map(item => item.id === b.id ? { ...item, title: e.target.value } : item);
                            setBanners(updated);
                            saveToLocal('affili_banners', updated);
                          }}
                        />
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = banners.map(item => item.id === b.id ? { ...item, image: e.target.value } : item);
                            setBanners(updated);
                            saveToLocal('affili_banners', updated);
                          }}
                        />
                      ...
                      <div className="flex items-center justify-between p-4 bg-gray-50 rounded-2xl">
                        ...
                        <input 
                          ...
                          onChange={(e) => {
                            ...
                            setSettings(updated);
                            saveToLocal('affili_settings', updated);
                          }}
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-2xl">
                        ...
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = { ...settings, instagram: e.target.value };
                            setSettings(updated);
                            saveToLocal('affili_settings', updated);
                          }}
                        />
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-2xl">
                        ...
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = { ...settings, facebook: e.target.value };
                            setSettings(updated);
                            saveToLocal('affili_settings', updated);
                          }}
                        />
                      ...
                      <div className="flex items-center gap-3 p-3 bg-gray-50 rounded-2xl">
                        ...
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = { ...settings, whatsapp: e.target.value };
                            setSettings(updated);
                            saveToLocal('affili_settings', updated);
                          }}
                        />
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex gap-3">
                        <input 
                          ...
                          onChange={(e) => {
                            const updated = { ...settings, adminPassword: e.target.value };
                            setSettings(updated);
                            saveToLocal('affili_settings', updated);
                          }}
                        />
